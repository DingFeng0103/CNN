...
# Run the commands below within a notebook cell to refresh  
# the face recognition weights files. This script can 
# be adapted to replace other files / folders

# First, remove the existing weights files
get_ipython().system('rm -rf /home/jovyan/work/week4/Face\\ Recognition/weights/')
# Next, replace with template weight files
get_ipython().system('cp -r -n /templates_files/home/jovyan/work/week4/Face\\ Recognition/weights/ /home/jovyan/work/week4/Face\\ Recognition/weights')
